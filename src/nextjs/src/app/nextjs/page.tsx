...
export default function NextJsDemo() {
  ...
  const endpointMap: Record<string, string> = {
    "Cloudflare R2": '/api/bm/create-presigned-url',
    "AWS S3": '/api/bucketmate-s3/create-presigned-url',
    "Minio": '/api/bucketmate-minio/create-presigned-url',
    "Digital Ocean": '/api/bucketmate-do/create-presigned-url',
  };
  ...
  async function deleteItem(name: string) {
    try {
      const res = await fetch('/api/bm/delete-object', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
